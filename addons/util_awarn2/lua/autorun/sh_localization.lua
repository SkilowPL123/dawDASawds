...
AWarn.localizations["RU"] = {
	cl1		=		"Menu SUP.Warns", --Found in cl_init.lua
	cl2		=		"Wersja", --Found in cl_init.lua
	cl3		=		"Kliknij PPM na gracza, aby uzyskać szczegółowe informacje!", --Found in cl_init.lua
	cl4		=		"Aktywne ostrzeżenia wybranego gracza", --Found in cl_init.lua
	cl5		=		"Wszystkie ostrzeżenia wybranego gracza", --Found in cl_init.lua
	cl6		=		"Opcje", --Found in cl_init.lua
	cl7		=		"Admin ostrzegający", --Found in cl_init.lua
	cl8		=		"Powód", --Found in cl_init.lua
	cl9		=		"Serwer", --Found in cl_init.lua
	cl10	=		"Data/Godzina", --Found in cl_init.lua
	cl11	=		"Usuń ostrzeżenie", --Found in cl_init.lua
	cl12	=		"Skopiuj do schowka", --Found in cl_init.lua
	cl13	=		"Powód ostrzeżenia skopiowany do schowka!", --Found in cl_init.lua
	cl14	=		"Nick gracza", --Found in cl_init.lua
	cl15	=		"Ostrzeż", --Found in cl_init.lua
	cl16	=		"Wyczyść ostrzeżenie", --Found in cl_init.lua
	cl17	=		"Zmniejsz aktywne ostrzeżenia", --Found in cl_init.lua
	cl18	=		"Przegląd twoich ostrzeżeń!", --Found in cl_init.lua
	cl19	=		"Twoje aktywne ostrzeżenia: ", --Found in cl_init.lua
	cl20	=		"Wszystkie twoje ostrzeżenia: ", --Found in cl_init.lua
	cl21	=		"Menu ostrzeżeń SUP.Warns", --Found in cl_init.lua
	cl22	=		"Warning Player: ", --Found in cl_init.lua
	cl23	=		"WYŚLIJ", --Found in cl_init.lua
	cl24	=		"ANULUJ", --Found in cl_init.lua
	cl25	=		"Menu opcji SUP.Warns", --Found in cl_init.lua
	cl26	=		"Zezwól SUP.Warns na wyrzucanie graczy (ustalone w pliku konfiguracyjnym kar)", --Found in cl_init.lua
	cl27	=		"Zezwól SUP.Warns na banowanie graczy (ustalone w pliku konfiguracyjnym kar)", --Found in cl_init.lua
	cl28	=		"Aktywne ostrzeżenia graczy będą usuwane z czasem.", --Found in cl_init.lua
	cl29	=		"Admini muszą podawać powód przy ostrzeganiu.", --Found in cl_init.lua
	cl30	=		"Aktywne ostrzeżenia graczy zostaną anulowane po banie przez SUP.Warns.", --Found in cl_init.lua
	cl31	=		"Loguj działania SUP.Warns do pliku danych.", --Found in cl_init.lua
	cl32	=		"Częstotliwość usuwania (w minutach)", --Found in cl_init.lua
	cl33	=		"Dodatkowe ustawienia/konfiguracje kar można znaleźć w:", --Found in cl_init.lua
	cl34	=		"otrzymał ostrzeżenie od", --Found in cl_init.lua
	cl35	=		"ostrzeżony", --Found in cl_init.lua/sv_init.lua
	cl36	=		"steamID musi być w cudzysłowie!", --Found in cl_init.lua/sv_init.lua
	cl37	=		"Nie znaleziono gracza!", --Found in cl_init.lua/sv_init.lua
	
	sv1		=		"Nie masz dostępu do tej komendy.", --Found in sv_init.lua
	sv2		=		"Nie możesz ustawić tego CVar tą komendą.", --Found in sv_init.lua
	sv3		=		"Musisz przekazać temu ConVar wartość dodatnią.", --Found in sv_init.lua
	sv4		=		"Nie możesz ostrzegać innych adminów.", --Found in sv_init.lua
	sv5		=		"MUSISZ podać powód. Można to wyłączyć w opcjach.", --Found in sv_init.lua
	sv6		=		"Zostałeś ostrzeżony przez gracza", --Found in sv_init.lua
	sv7		=		"Wpisz !warn aby zobaczyć listę swoich ostrzeżeń.", --Found in sv_init.lua/awarn_sql.lua
	sv8		=		"Ta komenda nie może być wykonana przez konsolę serwera!", --Found in sv_init.lua
	sv9		=		"Ten gracz nie może zostać ostrzeżony!", --Found in sv_awarn.lua
	sv10	=		"Gracze w tej grupie nie mogą być ostrzegani!", --Found in sv_awarn.lua
	
	sql1	=		"został wyrzucony za osiągnięcie limitu ostrzeżeń", --Found in awarn_sql.lua
	sql2	=		"został zbanowany za osiągnięcie limitu ostrzeżeń", --Found in awarn_sql.lua
	sql3	=		"Ten gracz nie ma ostrzeżeń", --Found in awarn_sql.lua
	sql4	=		"Zmniejszono liczbę ostrzeżeń o 1 dla gracza: ", --Found in awarn_sql.lua
	sql5	=		"Ten gracz ma już 0 aktywnych ostrzeżeń", --Found in awarn_sql.lua
	sql6	=		"Wyczyszczono wszystkie ostrzeżenia tego gracza", --Found in awarn_sql.lua
	sql7	=		"Nie znaleziono wpisu z tym ID ostrzeżenia!", --Found in awarn_sql.lua
	sql8	=		"Witaj ponownie!", --Found in awarn_sql.lua
	sql9	=		"Obecne aktywne ostrzeżenia", --Found in awarn_sql.lua
	sql10	=		"wszedł na serwer", --Found in awarn_sql.lua
	sql11	=		"Liczba ostrzeżeń", --Found in awarn_sql.lua
}

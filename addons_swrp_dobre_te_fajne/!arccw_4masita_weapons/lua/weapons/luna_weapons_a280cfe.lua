...
SWEP.IconOverride = "entities/tfa_ef_blaster_a280cfe.png"
...
SWEP.DefaultWMBodygroups = "00010"
SWEP.DefaultSkin = 0
...
SWEP.HullSize = 3 -- HullSize used by FireBullets
...
SWEP.RecoilVMShake = 0.8 -- random viewmodel offset when shooty
...
SWEP.ShootSound = "weapons/bf3/main/e22.wav"
...
SWEP.HolsterAng = Angle(-4.633, 30, -8)

-- When using custom sprint animations, set this to the same as ActivePos and ActiveAng
SWEP.SprintPos = SWEP.HolsterPos
SWEP.SprintAng = SWEP.HolsterAng
...
SWEP.Attachments = {
	[1] = {
		...
		Slot = "optic",
		Bone = "a280cfe", -- relevant bone any attachments will be mostly referring to
		Offset = {
            vpos = Vector(-0.15, -2.8, 6),
            vang = Angle(90, 0, -90),
        },
	},
	[2] = {
...
SWEP.Animations = {
	...
	["reload"] = {
		...
		SoundTable = {
	        {
				s = "everfall/Weapons/Handling/Reload_Gentle/Mag_Eject/023D-00000E36.mp3", -- sound; can be string or table
				p = 100, -- pitch
				v = 75, -- volume
				t = 0.07, -- time at which to play relative to Animations.Time
				c = CHAN_ITEM, -- channel to play the sound
			},
			{
				s = "everfall/Weapons/Handling/Reload_Gentle/Mag_Load/023D-00000793.mp3", -- sound; can be string or table
				p = 100, -- pitch
				v = 75, -- volume
			...
			{
				s = "EF_Weapon_Rifle_Overheat_Reset", -- sound; can be string or table
				p = 100, -- pitch
				v = 80, -- volume

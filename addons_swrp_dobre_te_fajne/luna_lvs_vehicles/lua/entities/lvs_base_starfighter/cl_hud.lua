...
function ENT:LVSHudPaintInfoText( X, Y, W, H, ScrX, ScrY, ply )
	...
	draw.DrawText( "km/h ", "LVS_FONT", X + 72, Y - 15, color_white, TEXT_ALIGN_RIGHT )
	draw.DrawText( kmh, "LVS_FONT_HUD_LARGE", X + 72, Y - 25, color_white, TEXT_ALIGN_LEFT )

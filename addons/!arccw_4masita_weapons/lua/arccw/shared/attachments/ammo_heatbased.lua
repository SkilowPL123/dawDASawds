...
att.PrintName = "Broń oparta na cieple"
att.Icon = Material("interfaz/armas/sw_powercell1.png")
att.Description = "Broń posiada teraz nieskończoną liczbę nabojów opartych na przegrzaniu. Zadajesz mniej obrażeń, a ich siła zmniejsza się wraz z odległością."

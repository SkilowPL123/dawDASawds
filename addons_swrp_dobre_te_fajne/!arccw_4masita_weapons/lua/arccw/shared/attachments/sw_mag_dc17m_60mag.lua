...
att.PrintName = "Удлиненный Магазин"
att.AbbrevName = "60-Round Mag"
att.SortOrder = 100
att.Icon = nil
att.Description = "Удлиненный магазин, идеально подходящий для дополнительной огневой поддержки. Небольшая громоздкость конструкции и дополнительная емкость патронов увеличивают вес оружия, что затрудняет обращение с ним"
att.Desc_Pros = {}
att.Desc_Cons = {}

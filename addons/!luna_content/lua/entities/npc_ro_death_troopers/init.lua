...
ENT.model = "models/nada/RO_Death_Troopers_npc.mdl"
...
ragdoll:SetBodygroup( 3, math.random(0,2))
ragdoll:SetBodygroup( 4, math.random(0,2))
ragdoll:SetBodygroup( 5, math.random(1,2))
ragdoll:SetBodygroup( 6, math.random(1,2))

...
att.PrintName = "Moduł Drobowika"
att.Icon = Material("entities/shotgun.png")
att.Description = "Moduł DC-17m Shotgun. Zmienia podstawowy strzał na strzał ze strzelby z kilkoma strzałami. Niezbędny do walki wręcz."
att.Desc_Pros = {}
att.Desc_Cons = {}
att.NotForNPCs = true
att.AutoStats = true

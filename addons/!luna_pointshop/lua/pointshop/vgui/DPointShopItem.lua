...
local fr
local function previewBanner( matPath )
	...
	banner:Dock(TOP)
	banner:SetTall( ResponsiveY(55) )
	banner:DockMargin( ResponsiveX(10), ResponsiveY(10), ResponsiveX(10), ResponsiveY(10) )

	banner.Paint = function( _, w, h )
		draw.Image( 0, 0, w, h, getCachedMaterial(matPath, true), color_white )
	end
end
...
function PANEL:SetData(data)
	...
	if data.Model and not data.Material then
		...
		DImageButton:SetMaterial(data.Material or mat_e)

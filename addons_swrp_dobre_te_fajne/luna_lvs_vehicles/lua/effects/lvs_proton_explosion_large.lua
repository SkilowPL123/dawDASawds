...
function EFFECT:Init( data )
	...
	for i = 0,30 do
		...
		if particle then
			...
			particle:SetStartSize( math.Rand(1000,1300) )
			particle:SetEndSize( math.Rand(3000,3300) )
	...
	for i = 0, 20 do
		...
		if particle then
			...
			particle:SetStartSize( math.Rand(500,550) )
	...
	for i = 0, 40 do
		...
		if particle then
			...
			particle:SetEndSize( math.Rand(700,750) )

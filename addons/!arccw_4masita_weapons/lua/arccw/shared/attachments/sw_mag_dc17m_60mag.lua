...
att.PrintName = "Wydłużony magazyn"
att.AbbrevName = "60-Round Mag"
att.SortOrder = 100
att.Icon = nil
att.Description = "Wydłużony magazynek, idealny do dodatkowego wsparcia ogniowego. Niewielka nieporęczność konstrukcji i dodatkowa pojemność nabojów zwiększają wagę broni, co utrudnia jej obsługę."
att.Desc_Pros = {}
att.Desc_Cons = {}

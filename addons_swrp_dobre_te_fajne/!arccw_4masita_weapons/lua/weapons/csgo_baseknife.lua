...
if ( SERVER ) then
 ...
 SWEP.desc = 'Виброклинок — это холодное оружие, оснащённое виброприводом, который заставляет лезвие колебаться с высокой частотой, позволяя ему легко разрезать броню и другие твёрдые материалы. Эти клинки часто использовались в ближнем бою, особенно среди бойцов, предпочитающих скрытные атаки и бесшумное устранение врагов.'
...
function SWEP:Initialize()
  self:SetHoldType( self.AreDaggers and "normal" or "knife" ) -- Avoid using SetWeaponHoldType! Otherwise the players could hold it wrong!
end

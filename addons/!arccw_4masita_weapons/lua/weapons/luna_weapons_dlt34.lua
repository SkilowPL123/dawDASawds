...
SWEP.Trivia_Class = "Blaster Machinegun"
SWEP.Trivia_Desc = "Squad support weapon, prone to overheating."
SWEP.Trivia_Manufacturer = "BlasTech Industries"
SWEP.Trivia_Calibre = "Medium Density Tibanna"
SWEP.Trivia_Mechanism = "Energized Compressed Tibanna"
SWEP.Trivia_Country = "GAR"

SWEP.IconOverride = "entities/tfa_ef_blaster_dlt34.png"
...
SWEP.RangeMin = 200 -- how far bullets will retain their maximum damage for
...
SWEP.Tracer = "tfa_tracer_ef_orange" -- override tracer (hitscan) effect
SWEP.TracerCol = Color(255, 94, 0)
...
SWEP.RecoilPunchBackMax = 0.6
SWEP.RecoilPunchBackMaxSights = nil -- may clip with scopes
SWEP.RecoilVMShake = 0.6 -- random viewmodel offset when shooty
...
SWEP.ShootSound = "EF_Weapon_DLT19_Fire"
...
SWEP.MuzzleFlashColor = Color(255, 94, 0)
...
SWEP.Jamming = false
SWEP.HeatCapacity = 180 -- rounds that can be fired non-stop before the gun jams, playing the "fix" animation
SWEP.HeatDissipation = 18 -- rounds' worth of heat lost per second
SWEP.HeatLockout = true -- overheating means you cannot fire until heat has been fully depleted
SWEP.HeatDelayTime = 5
...
SWEP.Attachments = {
	[1] = {
		...
		Slot = "optic",
		Bone = "dlt34", -- relevant bone any attachments will be mostly referring to
		Offset = {
            vpos = Vector(0, -2.248, 9.176),
            vang = Angle(90, 0, -90),
        },
	}
}
...
SWEP.Animations = {
	...
	["fire"] = {
		...
		SoundTable = {
	        {
				s = {
                    "everfall/weapons/miscellaneous/corebass/sniper/blasters_shared_corebass_close_sniper_var_01.mp3",
                    "everfall/weapons/miscellaneous/corebass/sniper/blasters_shared_corebass_close_sniper_var_02.mp3",
                    "everfall/weapons/miscellaneous/corebass/sniper/blasters_shared_corebass_close_sniper_var_03.mp3",
                    "everfall/weapons/miscellaneous/corebass/sniper/blasters_shared_corebass_close_sniper_var_04.mp3",
                    "everfall/weapons/miscellaneous/corebass/sniper/blasters_shared_corebass_close_sniper_var_05.mp3",
                    "everfall/weapons/miscellaneous/corebass/sniper/blasters_shared_corebass_close_sniper_var_06.mp3",
				}, -- sound; can be string or table
				p = 100, -- pitch
				v = 40, -- volume
				t = 0, -- time at which to play relative to Animations.Time
				c = CHAN_AUTO, -- channel to play the sound
			},
		}
    },
	["fire_sight"] = {
	...
	["reload"] = {
		...
		SoundTable = {
	        {
				s = "EF_Weapon_WestarReload_1", -- sound; can be string or table
				p = 100, -- pitch
				v = 75, -- volume
				t = 0, -- time at which to play relative to Animations.Time

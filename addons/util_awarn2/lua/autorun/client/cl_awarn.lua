...
function awarn_menu()
	...
	MenuPanelButton:SetText( "Gracz offline" )
...
function awarn_offlineplayerprompt()
	...
	MenuFrame:SetTitle( "Wybierz gracza offline" )
	...
	MenuPanelLabel1:SetText( "SteamID gracza offline" )
	...
	MenuPanelButton1.DoClick = function( MenuPanelButton1 )
		...
		AWarn.MenuFrame.MenuPanel2Text5:SetText( "Pokazuj ostrzeżenia dla graczy OFFLINE: " .. MenuPanelTextEntry1:GetValue() )
		AWarn.MenuFrame.MenuPanel2Text5:SizeToContents()
		MenuFrame:Close()
	end
...
net.Receive("AWarnNotification", function(length )
	...
	if target == game.GetWorld() then
		...
		if admin:EntIndex() == 0 then
			chat.AddText( Color(17, 148, 240), "SUP.Warns • ", Color(255,255,255), "steamid ", Color(255,0,0), tarid,  Color(255,255,255), " " .. AWarn.localizations[loc].cl34 .. " ", Color(17, 148, 240), "SUP.System • ", Color(255,255,255), ": ", Color(150,40,40), reason )
		else
			chat.AddText( Color(17, 148, 240), "SUP.Warns • ", Color(255,255,255), "steamid ", Color(255,0,0), tarid,  Color(255,255,255), " " .. AWarn.localizations[loc].cl34 .. " ", admin, Color(255,255,255), ": ", Color(150,40,40), reason )
		end
	else
		if admin:EntIndex() == 0 then
			chat.AddText( Color(17, 148, 240), "SUP.Warns • ", target, Color(255,255,255), " " .. AWarn.localizations[loc].cl34 .. " ", Color(17, 148, 240), "SUP.System • ", Color(255,255,255), ": ", Color(150,40,40), reason )
		else
			chat.AddText( Color(17, 148, 240), "SUP.Warns • ", target, Color(255,255,255), " " .. AWarn.localizations[loc].cl34 .. " ", admin, Color(255,255,255), ": ", Color(150,40,40), reason )
		end
	end
end)
...
net.Receive("AWarnNotification2", function(length )
    ...
    if admin:EntIndex() == 0 then
        chat.AddText( Color(17, 148, 240), "SUP.Warns • ", Color(17, 148, 240), "SUP.System • ", Color(255,255,255), " " .. AWarn.localizations[loc].cl35 .. " ", Color(255,0,0), target, Color(255,255,255), ": ", Color(150,40,40), reason )
    else
        chat.AddText( Color(17, 148, 240), "SUP.Warns • ", admin, Color(255,255,255), " " .. AWarn.localizations[loc].cl35 .. " ", Color(255,0,0), target, Color(255,255,255), ": ", Color(150,40,40), reason )
    end
end)
...
function awarn_sendwarning( tar, reason )
	...
	if (string.sub(string.lower( tar ), 1, 5) == "steam") then
		if string.len( tar ) == 7 then
			LocalPlayer():PrintMessage( HUD_PRINTTALK, "SUP.Warns • " .. AWarn.localizations[loc].cl36 )
		end
	...
	if awarn_getUser( tar ) then
		...
		LocalPlayer():PrintMessage( HUD_PRINTTALK, "SUP.Warns • " .. AWarn.localizations[loc].cl37 )
	end
end

...
if SERVER or CLIENT then
    ...
    function lsst:OpenMenu( ply )
        ...
        if true then
            pan.P_Right = pan:Add( "DPanel" )  local pax = pan.P_Right
            pax:SetPos( 74, 41 )
            pax:SetSize( 718, 575 )
            pax.N_Lerp1 = 0
            pax.N_Lerp2 = 0
        ...
        if true then
            pan.P_Tree = pan.P_Right:Add( "DPanel" )  local pax = pan.P_Tree
            pax:SetPos( 2, 41 )
            pax:SetSize( 714, 532 )
            pax.T_Pans = {}
            function pax:Paint( w, h )
        ...
        if true then
            pan.P_Note = pan.P_Right:Add( "DPanel" )  local pax = pan.P_Note
            pax:SetPos( 595, 465 )
            pax:SetSize( 150, 92 )
        ...
        function pan:UpdateTree( ski, no )
            ...
            pan.P_Part1 = pan.P_Tree:Add( "DPanel" )  local pax = pan.P_Part1
            pax:SetSize( 250, 400 )
            pax:SetPos( 457, 8 )
            ...
            pan.P_Part2 = pan.P_Tree:Add( "DButton" )  local pax = pan.P_Part2
            pax:SetSize( 250, 45 )
            pax:SetPos( 457, 420 )
            pax:SetText( "" )
            pax.B_Hover = false
            ...
            pan.P_Part6 = pan.P_Tree:Add( "DPanel" )  local pax = pan.P_Part6
            pax:SetSize( 442, 40 )
            pax:SetPos( 6, 8 )
            pax.N_Nums = 0
            function pax:Paint( w, h )

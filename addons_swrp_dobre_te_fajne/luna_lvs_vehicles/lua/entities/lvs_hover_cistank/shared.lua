...
ENT.MDL = "models/salty/cis_ground_armored_tank.mdl"
ENT.GibModels = {
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		...
		local bullet = {}
		bullet.Src = veh:LocalToWorld( ent.SwapTopBottom and Vector(135.88,57.5,120.79) or Vector(135.88,-57.5,120.79) )
	...
	weapon.Attack = function( ent )
		...
		for i = 1, 2 do
			timer.Simple( (i / 5) * 0.75, function()
				...
				local ID_L = ent:LookupAttachment( "laser_l" )
				local ID_R = ent:LookupAttachment( "laser_r" )
...
ENT.EngineSounds = {
	{
		sound = "cistank/vat_engine_lp.wav",
		Pitch = 100,
		PitchMin = 0,
		PitchMax = 255,
		PitchMul = 30,

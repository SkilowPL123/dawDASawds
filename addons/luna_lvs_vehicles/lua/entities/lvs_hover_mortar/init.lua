...
function ENT:OnSpawn( PObj )
	...
	local DriverSeat = self:AddDriverSeat( Vector(-209.18,38.03,220.73), Angle(0,-90,0) )
	DriverSeat:SetCameraDistance( 0.1 )
	DriverSeat.HidePlayer = true

	self.PrimarySND = self:AddSoundEmitter( Vector(60,0,8), "cistank/turbolaser_fire.wav", "cistank/turbolaser_fire.wav" )
	self.PrimarySND:SetSoundLevel( 110 )
	
	self.SNDTail = self:AddSoundEmitter( Vector(200,0,150), "cistank/heavy_laser_shoot.wav", "cistank/heavy_laser_shoot.wav" )

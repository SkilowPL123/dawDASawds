...
SWEP.PrintName = "Tablet inżyniera"
SWEP.Author =	"Joe"
...
function SWEP:PostDrawViewModel(vm, wep, ply)
	...
	cam.Start3D2D(pos, ang, 0.1)
		...
		local sizex = surface.GetTextSize("Nazwa: " .. data.name) + 30
		...
		draw.ShadowSimpleText("Nazwa: " .. data.name, luna.MontBase24, 0, 10, col1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.ShadowSimpleText("HP: " .. data.health, luna.MontBase24, 0, 60, col1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.ShadowSimpleText("Czas: " .. data.buildtime .. "s", luna.MontBase24, 0, 110, col1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.ShadowSimpleText("Koszt: " .. data.neededresources, luna.MontBase24, 0, 160, col1, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	cam.End3D2D()

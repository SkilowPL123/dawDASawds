...
att.PrintName = "Granatnik podlufowy"
att.AbbrevName = "Granatnik podlufowy"
att.Icon = Material("interfaz/iconos/jedi/453218427_4064545516.png", "mips smooth")
att.Description = "Jednorazowy granatnik podlufowy przeznaczony dla piechoty specjalnej."

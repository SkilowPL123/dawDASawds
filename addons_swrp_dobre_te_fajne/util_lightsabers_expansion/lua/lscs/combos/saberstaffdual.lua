...
COMBO.id = "saberstaffdual"
COMBO.PrintName = "Double Blade Staff Dual"
COMBO.Author = "RareLogan"
COMBO.Description = "This is logical right?"
...
COMBO.HoldType = "wos-saber-staffdual"

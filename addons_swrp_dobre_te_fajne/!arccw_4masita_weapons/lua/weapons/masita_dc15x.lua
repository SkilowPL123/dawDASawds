...
SWEP.Trivia_Desc = "Снайперская винтовка DC-15x - это снайперская винтовка, созданная для снайперов-клонов Галактической Республики путем значительной модификации стандартной бластерной винтовки DC-15A."

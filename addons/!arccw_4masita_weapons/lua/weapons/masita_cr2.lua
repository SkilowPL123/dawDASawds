...
SWEP.Trivia_Desc = "CR-2 - Тяжелый бластерный пистолет, который производился компанией Corellian Arms, которая поставляла вооружение Королевской Гвардии НАбу. Она, маленькая и легкая винтовка, имела крайне усиленную скорострельность и стреляла ионизированными болтами. Она также может иметь модуль прицелов с ПНВ или увеличенный ствол для сокращения разброса"

...
att.PrintName = "Стандартные Тренировки"

att.Icon = Material("", "smooth mips")
att.Description = [[Самая базовая тренировка по обращению с оружием.
Теперь вы сражаетесь на базовом уровне...]]
att.Desc_Pros = {
}
att.Desc_Cons = {
}
att.Desc_Neutrals = {
	"Может быть, обучение принесет свои плоды..",
}
att.Slot = {"perk"}

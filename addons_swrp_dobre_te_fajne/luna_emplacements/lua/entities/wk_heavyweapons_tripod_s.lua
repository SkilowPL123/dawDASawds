...
function ENT:Initialize()
	...
	if SERVER then
		self:SetModel( "models/ordoredactus/emplacements/tripod_s_deployed.mdl" )
...
function ENT:TurnToItem()
	if SERVER then
		...
		WKItems.ItemSpawn( "heavyweapons_tripod_s", self:GetPos(), self:GetAngles(), {} )
		self:Remove()
	end
end

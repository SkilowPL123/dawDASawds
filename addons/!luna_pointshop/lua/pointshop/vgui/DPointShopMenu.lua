...
surface.CreateFont( "PS_Default", {
	font = system.IsLinux() and "Mont Bold" or "Mont Bold",
...
local mat_currency = Material( "luna_menus/f4/money.png", "smooth noclamp" )
local mat_bg = Material( "luna_ui_base/bg5.png", "smooth noclamp" )
local mat_bg1 = Material( "luna_ui_base/luna-ui_bg_blank.png", "smooth noclamp")
local color_black = Color(255, 255, 255, 255)
...
function PANEL:Paint(w, h)
    ...
    draw.Icon( wt+30, 2, 22, 22, mat_currency, Color(255,200,10,255) )

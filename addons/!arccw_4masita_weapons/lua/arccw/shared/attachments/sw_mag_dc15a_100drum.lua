...
att.PrintName = "Bębnowy magazynek"
att.AbbrevName = "100-Round Mag"
att.SortOrder = 100
att.Icon = nil
att.Description = "Magazynek dwubębnowy, idealny do prowadzenia ognia zaporowego. Nieporęczna konstrukcja i duża pojemność amunicji znacznie zwiększają wagę broni, utrudniając jej obsługę. Skłonność do awarii."
att.Desc_Pros = {}
att.Desc_Cons = {}

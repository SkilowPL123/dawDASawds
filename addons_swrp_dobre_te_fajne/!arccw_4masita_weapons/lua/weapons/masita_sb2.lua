...
SWEP.Trivia_Desc = "SB-2 - это тип бластера, способный пробивать вражескую оборону. Его использовали солдаты-клоны Великой армии Республики во время Войн клонов между Галактической Республикой и Конфедерацией независимых систем. DP-23 стрелял синими бластерными болтами, имел ребристый ствол с заостренным дулом, черную ложу и небольшую рукоятку."

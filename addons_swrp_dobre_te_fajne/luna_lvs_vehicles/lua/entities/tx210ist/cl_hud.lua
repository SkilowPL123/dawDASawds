...
function ENT:PaintCrosshairDropOuter( Pos2D, Col )
	if not Col then
		Col = Color( 255, 255, 255, 255 )
	end
	local Start = 12
	...
	surface.DrawLine( Pos2D.x + 75, Pos2D.y + 1, Pos2D.x - 75, Pos2D.y + 1 ) -- sideways line
	surface.DrawLine( Pos2D.x + 60, Pos2D.y + 5, Pos2D.x - 60, Pos2D.y + 5 ) -- sideways line
	surface.DrawLine( Pos2D.x + 40, Pos2D.y + 15, Pos2D.x - 40, Pos2D.y + 15 ) -- sideways line
	surface.DrawLine( Pos2D.x + 20, Pos2D.y + 30, Pos2D.x - 20, Pos2D.y + 30 ) -- sideways line
	surface.DrawLine( Pos2D.x + 10, Pos2D.y + 60, Pos2D.x - 10, Pos2D.y + 60 ) -- sideways line
	surface.DrawLine( Pos2D.x + 5, Pos2D.y + 110, Pos2D.x - 6, Pos2D.y + 110 ) -- sideways line
	surface.DrawLine( Pos2D.x - .5, Pos2D.y + 120, Pos2D.x - .5, Pos2D.y + Start - dst )
	...
	if LVS.AntiAliasingEnabled then
		...
		surface.DrawLine( Pos2D.x + 75, Pos2D.y + 2, Pos2D.x - 75, Pos2D.y + 2 ) -- sideways line
	surface.DrawLine( Pos2D.x + 60, Pos2D.y + 6, Pos2D.x - 60, Pos2D.y + 6 ) -- sideways line
	surface.DrawLine( Pos2D.x + 40, Pos2D.y + 16, Pos2D.x - 40, Pos2D.y + 16 ) -- sideways line
	surface.DrawLine( Pos2D.x + 20, Pos2D.y + 31, Pos2D.x - 20, Pos2D.y + 31 ) -- sideways line
	surface.DrawLine( Pos2D.x + 10, Pos2D.y + 61, Pos2D.x - 10, Pos2D.y + 61 ) -- sideways line
	surface.DrawLine( Pos2D.x + 5, Pos2D.y + 111, Pos2D.x - 6, Pos2D.y + 111 ) -- sideways line
	surface.DrawLine( Pos2D.x - .5, Pos2D.y + 121, Pos2D.x - .5, Pos2D.y + Start - dst )

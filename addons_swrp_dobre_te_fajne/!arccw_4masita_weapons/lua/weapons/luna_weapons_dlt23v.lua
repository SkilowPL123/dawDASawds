...
SWEP.Trivia_Desc = "High tech heat resistant squad support gun"
SWEP.Trivia_Manufacturer = "BlasTech Industries"
SWEP.Trivia_Calibre = "Medium Density"
SWEP.Trivia_Mechanism = "Energized Compressed Tibanna"
SWEP.Trivia_Country = "GAR"

SWEP.IconOverride = "entities/tfa_ef_blaster_dlt23v.png"
...
SWEP.ShootSound = "Weapon_DLT23V.Single"
...
SWEP.Jamming = false
SWEP.HeatCapacity = 400 -- rounds that can be fired non-stop before the gun jams, playing the "fix" animation
...
SWEP.HolsterPos = Vector(5.532, 0, -0)
...
SWEP.Animations = {
    ["idle"] = {
        Source = "idle",
		RareSource = "fidget", -- 1/RareSourceChance of playing this animation instead
	...
	["fire"] = {
		...
		SoundTable = {
	        {
				s = {
                    "everfall/weapons/miscellaneous/corebass/silenced/blasters_shared_corebass_silenced_close_var_01.mp3",
                    "everfall/weapons/miscellaneous/corebass/silenced/blasters_shared_corebass_silenced_close_var_02.mp3",
                    "everfall/weapons/miscellaneous/corebass/silenced/blasters_shared_corebass_silenced_close_var_03.mp3",
                    "everfall/weapons/miscellaneous/corebass/silenced/blasters_shared_corebass_silenced_close_var_04.mp3",
	...
	["reload"] = {
		...
		SoundTable = {
	        {
				s = "weapons/bf3/dlt23v_reload6.wav", -- sound; can be string or table
				p = 100, -- pitch
				v = 75, -- volume
				t = 0, -- time at which to play relative to Animations.Time

...
SWEP.Trivia_Class = "Тяжелый Бластерный Дробовик"
SWEP.Trivia_Desc = "DP-23 - это тип бластера, способный пробивать вражескую оборону. Он использовался солдатами-клонами Великой армии Республики во время Войн клонов между Галактической Республикой и Конфедерацией независимых систем. DP-23 стрелял синими бластерными болтами, имел ребристый ствол с заостренным дулом, черную ложу и небольшую рукоятку."

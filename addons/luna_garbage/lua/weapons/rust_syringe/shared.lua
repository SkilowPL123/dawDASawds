...
SWEP.HealAmount = 100 -- there will actually 15 cause regeneration makes instant +1 hp
SWEP.RegenAmount = 100 -- 21 to compensate it
...
function SWEP:PrimaryAttack()
    ...
    -- print(Owner:GetAmmoCount(self.Primary.Ammo))

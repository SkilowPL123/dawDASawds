...
SWEP.Trivia_Desc = "Reliable blaster shotgun"
SWEP.Trivia_Manufacturer = "BlasTech Industries"
SWEP.Trivia_Calibre = "Medium Density"
SWEP.Trivia_Mechanism = "Energized Compressed Tibanna"
SWEP.Trivia_Country = "GAR"

SWEP.IconOverride = "entities/tfa_ef_blaster_scattergun.png"

SWEP.ViewModel = "models/everfall/weapons/viewmodels/c_scattergun.mdl"
SWEP.WorldModel = "models/everfall/weapons/worldmodels/w_scattergun.mdl"
...
SWEP.RangeMin = 5 -- how far bullets will retain their maximum damage for
...
SWEP.Tracer = "tfa_tracer_ef_yellow" -- override tracer (hitscan) effect
SWEP.TracerCol = Color(255, 217, 0)
...
SWEP.Primary.Ammo = "Tibanna_LowDensity" -- what ammo type the gun uses
...
SWEP.ShootSound = "EF_Weapon_Scattergun_Fire"
...
SWEP.MuzzleFlashColor = Color(255, 251, 0)
...
SWEP.KeepBaseIrons = true -- do not override iron sights when scope installed
SWEP.BaseIronsFirst = false -- If a sight keeps base irons, irons comes first

SWEP.IronSightStruct = {
    Pos = Vector(-5.08, 0, 3.74),
    Ang = Angle(0, 0, 0),
...
SWEP.Jamming = false
SWEP.HeatCapacity = 8 -- rounds that can be fired non-stop before the gun jams, playing the "fix" animation

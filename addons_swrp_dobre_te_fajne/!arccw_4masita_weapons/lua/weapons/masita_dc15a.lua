...
SWEP.Trivia_Desc = "DC-15a — оснащалась снайперским прицелом, который хранился снизу цевья. Когда возникала необходимость в стрельбе на большое расстояние, прицел устанавливался на положенное место. Оружие снаряжалось картриджем с газом тибанна и батареей для примерно 240 выстрелов, в зависимости от параметров настройки силы оружия (самая высокая настройка силы позволяла произвести 50 выстрелов на картридж)."
SWEP.Trivia_Manufacturer = "Индустрии «Бластех»"

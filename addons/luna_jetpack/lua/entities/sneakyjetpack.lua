...
function ENT:Initialize()
	...
	if SERVER then
		...
		self:SetFuelDrain(40)	--drain in seconds
...
function ENT:SetupDataTables()
	...
	self:DefineNWVar( "Float" , "FuelDrain" , true , "Seconds to drain fuel" , 10 , 10 ) --how many seconds it's gonna take to drain all the fuel
	self:DefineNWVar( "Float" , "FuelRecharge" , true , "Seconds to recharge the fuel" , 30 , 60 ) --how many seconds it should take to fully recharge this

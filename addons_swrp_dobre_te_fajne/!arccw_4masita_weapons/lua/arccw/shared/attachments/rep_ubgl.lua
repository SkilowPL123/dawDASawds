...
att.PrintName = "Подствольный гранатомет"
att.AbbrevName = "Подствольный гранатомет"
att.Icon = Material("interfaz/iconos/jedi/453218427_4064545516.png", "mips smooth")
att.Description = "Однозарядный подствольный гранатомет, предназначенный для специальной пехоты."

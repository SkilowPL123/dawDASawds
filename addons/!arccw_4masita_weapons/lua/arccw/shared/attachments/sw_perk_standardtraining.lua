...
att.PrintName = "Standardowe treningi"

att.Icon = Material("", "smooth mips")
att.Description = [[Najbardziej podstawowy trening posługiwania się bronią.
Teraz walczysz na poziomie podstawowym...]]
att.Desc_Pros = {
}
att.Desc_Cons = {
}
att.Desc_Neutrals = {
	"Być może nauka przyniesie efekty...",
}
att.Slot = {"perk"}

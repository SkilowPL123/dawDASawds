...
function ENT:Initialize()
    ...
    if WireAddon ~= nil then
        self.Inputs = WireLib.CreateSpecialInputs(self, {"AssignNPC", "AssignInRange", "NPC", "Range", "Filter"}, {"NORMAL", "NORMAL", "ENTITY", "NORMAL", "STRING"})
    end
end
...
function ENT:CreateRoute(npc)
    ...
    --end
    if IsValid(npc.pr_prcontroller) then
        npc.pr_prcontroller:Remove()
    end

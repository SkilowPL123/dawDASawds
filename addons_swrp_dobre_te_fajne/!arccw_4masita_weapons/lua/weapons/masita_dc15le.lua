...
SWEP.Trivia_Class = "Тяжелая винтовка для работы на дальних дистанциях"
SWEP.Trivia_Desc = "Бластерная винтовка DC-15le, известная просто как бластерная винтовка DC-15, - это тяжелая бластерная винтовка, производимая компанией BlasTech Industries и входящая в семейство DC-15. Во время Войн клонов против Конфедерации независимых систем она была одним из стандартных видов оружия клон-десантников Галактической Республики - армии клонированных солдат Великой армии Республики."

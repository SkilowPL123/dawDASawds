...
language.Add( "tool.rb655_easy_bodygroup.left", "Wybierz obiekt" )
language.Add( "tool.rb655_easy_bodygroup.reload", "Wybierz siebie" )

language.Add( "tool.rb655_easy_bodygroup.name", "Bodygroupy" )
language.Add( "tool.rb655_easy_bodygroup.desc", "Zmienia bodygroupy i skiny" )
--language.Add( "tool.rb655_easy_bodygroup.1", "Use context menu to edit bodygroups or skins" )

language.Add( "tool.rb655_easy_bodygroup.noglow", "Wyłącz podświetlenie" )
language.Add( "tool.rb655_easy_bodygroup.skin", "Skin" )
language.Add( "tool.rb655_easy_bodygroup.badent", "Prop lub model nie ma niczego... Nuda." )
language.Add( "tool.rb655_easy_bodygroup.noent", "Nic nie wybrałeś, bro." )

...
SWEP.Trivia_Class = "Тяжелая бластерная винтовка"
SWEP.Trivia_Desc = "Бластерная винтовка DC-15A, также известная как просто бластерная винтовка DC-15, была тяжелой бластерной, которая производилась BlastTech Industries, как часть семьи DC-15. Это была одна из наиболее распостраненных винтовок Великой Армии Клонов во время Воин Клонов против Конфедерации Независимых Систем. Тяжелая модификация DC-15A имеет увеличенную скорострельность практически без потерь в уроне."

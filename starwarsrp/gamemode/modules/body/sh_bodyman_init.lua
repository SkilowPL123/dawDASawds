...
luna.loader.Server("bodyman/bodyman_server.lua")
luna.loader.Server("bodyman/bodyman_server_hooks.lua")
luna.loader.Server("bodyman/bodyman_config.lua")

luna.loader.Client("bodyman/bodyman_config.lua")
luna.loader.Client("bodyman/bodyman_client.lua")
luna.loader.Client("bodyman/arizard_derma.lua")
